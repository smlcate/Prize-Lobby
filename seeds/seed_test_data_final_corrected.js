...
exports.seed = async function(knex) {
  ...
  await knex('transactions').insert([
    { user_id: 1, type: 'deposit', amount: 100.00 },
    { user_id: 2, type: 'deposit', amount: 50.00 },
    { user_id: 3, type: 'deposit', amount: 75.00 },
    { user_id: 4, type: 'deposit', amount: 20.00 }
  ]);
  ...
  await knex('bracket_matches').insert([
    { event_id: 1, round: 1, match_number: 0, player1_id: 1, player2_id: 2, status: 'pending' },
    { event_id: 1, round: 1, match_number: 1, player1_id: 3, player2_id: 4, status: 'pending' }
  ]);
};
